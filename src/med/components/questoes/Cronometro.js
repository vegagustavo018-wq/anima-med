 ...
 */
export function Cronometro({ segundos, pausado = false, aoZerar, }) {
    ...
    return (_jsxs("span", { role: "timer", "aria-label": `Tempo restante ${mm} minutos e ${ss} segundos`, className: critico ? 'anima-pulso-luz' : undefined, style: {
        ...
        }, children: [String(mm).padStart(2, '0'), ":", String(ss).padStart(2, '0')] }));
}
