...
export function conclusaoBloco(titulo, temFuturas) {
    if (temFuturas) {
        return escolher([
...
export function noVazio(titulo) {
    return escolher([
...
export function fimDeSessao(cardsRevisados) {
    if (cardsRevisados === 0)
        return `Até logo. Volto a estar aqui quando você voltar.`;
    return escolher([
