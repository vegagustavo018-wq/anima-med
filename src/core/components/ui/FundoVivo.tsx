...
/**
 * Fundo vivo — plâncton bioluminescente à deriva. Uma camada de canvas fixa,
 * atrás de todo o conteúdo, com pontos de luz suaves subindo devagar como num
 * oceano profundo. É a "respiração" visual do organismo.
 *
 * Barato de propósito: poucas partículas, sem conexões caras, pausado quando a
 * aba está oculta ou o usuário pediu "reduzir movimento". pointer-events:none,
 * então nunca intercepta cliques.
 */
...
interface Particula {
  ...
  r: number
  velY: number
  faseW: number // fase do balanço horizontal
  ampW: number // amplitude do balanço
  brilhoBase: number
}
